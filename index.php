...
<div class="container">
	<h2 align="center"  style="color:#868e96;">Welcome to the Smart Arthritis Diagnosis WebPortal</h2>
	<div class="row">
          ...
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              ...
              <h1>Product Functions</h1>
				...
				<p>
				<ul>
<li>Diagnosis of Rheumatoid Arthritis.</li>
<li>Recommend remedies to flagged patients.</li>
<li>Enable patients to monitor progression of the disease.</li>
</ul>
              </p></strong>
            </div>
          </div>
          ...
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>Product Functions</h1>
				<strong><p>
				<ul>
<li>Fill the communication gap between arthritis patients and doctors.</li>
<li>Direct patients to nearest medical center.</li>
<li>Give information about rheumatoid arthritis.</li>
</ul>
             </strong>
            </div>
          </div>
