...
<!--      <div class="top-bar">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05" >
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link active" href="patienthome.php">Home</a>
              </li>
            <!--  Drop down menu commented out
    ...
    <!-- END section -->
<div class="container">
 <h2 align="center"  style="color:#868e96;">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome </h2>
  <div class="row">
    <div class="col-md-6">
    <!--<h4 align="center">About the system</h4>-->
      <br>
      <p>The Smart Arthritis Diagnosis system will simplify the diagnosis and monitoring of arthritis disease
for both patients and doctors.
        <br>It will be able to recommend remedies to patients as well as bridging
the communication gap between patients and doctors.</p>
      <p>The system will enable patients to conveniently, easily and quickly perform a diagnosis of
Arthritis.
<br>The system will allow patients and doctors to monitor the progression of the disease and advise
them accordingly.</p>
